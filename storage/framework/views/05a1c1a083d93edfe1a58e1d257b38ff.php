...
<div class="admin-page">
    <div class="admin-container">
        ...
        <div class="admin-header">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="admin-back">← Панель управления</a>
        </div>
        ...
        <div class="gallery-grid">
            ...
            <div class="gallery-card">
                <img src="<?php echo e(asset('storage/' . $image->image_path)); ?>" alt="<?php echo e($image->title ?? 'Изображение'); ?>" class="gallery-card__image">
                <div class="gallery-card__body">
                    <div class="gallery-card__title"><?php echo e($image->title ?? 'Без названия'); ?></div>
                    <span class="gallery-card__category"><?php echo e($image->category); ?></span>
                    <form action="<?php echo e(route('admin.gallery.delete', $image)); ?>" method="POST" onsubmit="return confirm('Удалить изображение?')">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\gory\resources\views/admin/gallery/index.blade.php ENDPATH**/ ?>