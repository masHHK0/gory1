    ...
    <div class="profile-container">
        ...
        <aside class="profile-sidebar">
            ...
            <nav class="profile-menu">
                <a href="<?php echo e(route('profile')); ?>" class="profile-menu__link active">
                    Профиль
                </a>
                <a href="<?php echo e(route('bookings')); ?>" class="profile-menu__link">
                    Мои бронирования
                </a>
            </nav>
        </aside>
                ...
                <div class="profile-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name', Auth::user()->name)); ?>" class="form-input" placeholder="Введите имя" required>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">Email</label>
                            <input type="email" name="email" value="<?php echo e(old('email', Auth::user()->email)); ?>" class="form-input" placeholder="Введите email" required>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">Телефон</label>
                            <input type="tel" name="phone" value="<?php echo e(old('phone', Auth::user()->phone)); ?>" class="form-input" placeholder="+7 999 123-45-67">
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">Дата регистрации</label>
                            <input type="text" value="<?php echo e(Auth::user()->created_at->format('d.m.Y')); ?>" class="form-input" disabled>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\gory\resources\views/profile.blade.php ENDPATH**/ ?>